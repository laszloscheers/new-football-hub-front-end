...
export const findLeagueCode = (leagueName: string): string | undefined => {
...
export const findClubId = (clubName: string): number | undefined => {
  ...
  return filtered.length > 0 ? filtered[0].id : undefined;
};
